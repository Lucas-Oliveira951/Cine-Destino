    ...
    <header>
        ...
        <nav class="menu">
            ...
            <ul class="nav-list">
                ...
                <a href="../cinedestino/cadastro_de_usuarios/login.php" class="botao-login">Entrar</a>
            </ul>
        </nav>
        ...
        <nav class="menu-lateral">
            <ul>
                ...
                <li><a href="../cinedestino/cadastro_de_usuarios/login.php"><i class="fa-solid fa-envelope"></i>Entrar</a></li>
            </ul>
